...
let stdenv = (exports.stdenv = function() {
  ...
  return {
    true: Bool,
    false: Bool,
    zero: Function(Int, Bool),
    succ: Function(Int, Int),
    pred: Function(Int, Int),
    times: Function(Int, Function(Int, Int)),
    pair: Function(pairLeft, Function(pairRight, Pair(pairLeft, pairRight)))
  };
});
...
function unify(type1, type2) {
  ...
  } else if (t1.type === "op" && t2.type === "var") {
    unify(t2, t1);
...
let analyse = (exports.analyse = function analyse(ast, env, nongen = []) {
  switch (ast.type) {
    case "Id": {
    ...
    case "Call": {
      ...
      unify(Function(argtype, restype), funtype);
      return restype;
    }
    case "Fun": {
      ...
      return Function(argtype, restype);
    }
    case "Let": {
...
let check = (exports.check = function check(code) {
